...
#### A guide on setting up macOS/iOS/iPadOS with all the essential Applications, Tools, and Games to make your experience with  macOS/iOS/iPadOS great! 

**Note: You can easily convert this markdown file to a PDF in [VSCode](https://code.visualstudio.com/) using this handy extension [Markdown PDF](https://marketplace.visualstudio.com/items?itemName=yzane.markdown-pdf).**

<p align="center">
 <img src="https://user-images.githubusercontent.com/45159366/145648808-8e05ead9-16dd-4782-90f4-ce2100ffc535.png">
  <br />
</p>

# Table of Contents

1. [Getting Started](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#getting-started)
...
5. [Gaming](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#gaming)

6. [Game Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#game-development)

7. [Setting up a Windows 10 Workspace](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#setting-up-a-windows-10-workspace)

8. [Using Android and Android Apps on macOS](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#using-android-and-android-apps-on-macos)

9. [Professional Audio/Video Editing](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#professional-audio--video-editing)

10. [3D Graphics and Design](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#3d-graphics-and-design)

11. [Kubernetes](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#kubernetes)

12. [Machine Learning](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#machine-learning)

13. [Robotics](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#robotics)

14. [Open Source Security](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#open-source-security)

15. [Differential Privacy](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#differential-privacy)

16. [DevOps](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#devops)

17. [React Native Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide#react-native-development)

18. [Flutter Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#flutter-development)

19. [Node.js Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#nodejs-development) 

20. [C/C++ Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#cc-development)

21. [Java Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#java-development)

22. [C# Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide#c-development)

23. [.NET Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide#net-development)

24. [Python Development](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#python-development)

25. [Networking](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#networking)

26. [Databases](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/blob/main/README.md#databases)
...
# Using Android and Android Apps on macOS
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/macOS-iOS-iPadOS-Guide/pulls).
